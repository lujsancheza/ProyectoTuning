...
- The web frontend in `src/turning.Web` MUST communicate only through endpoints exposed by `src/turning.API`; it MUST NOT access infrastructure, databases, or external AI providers directly.
...
**Version**: 1.0.1 | **Ratified**: 2026-04-30 | **Last Amended**: 2026-04-30
